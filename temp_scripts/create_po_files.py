...
en_translations = {
    ...
    "Upload a chest X-ray image to detect abnormal using our advanced deep learning model. Accuracy: 96.13% (validated through 5-fold cross-validation)": "Upload a chest X-ray image to detect abnormal using our advanced deep learning model. Accuracy: 96.13% (validated through 5-fold cross-validation)",
    ...
    "Abnormal Probability:": "Abnormal Probability:",
    "ago": "ago",
    "MB": "MB",
    "s": "s",
    ...
    "Lung disease classifier uses a deep learning model based on Convolutional Neural Networks (CNN) to analyze chest X-ray images and detect signs of abnormal.": "Lung disease classifier uses a deep learning model based on Convolutional Neural Networks (CNN) to analyze chest X-ray images and detect signs of abnormal.",
    "The model has been trained on a large dataset of chest X-ray images, learning to identify patterns and features that are indicative of abnormal. When you upload an image, it goes through the following process:": "The model has been trained on a large dataset of chest X-ray images, learning to identify patterns and features that are indicative of abnormal. When you upload an image, it goes through the following process:",
...
lt_translations = {
    ...
    "Upload a chest X-ray image to detect abnormal using our advanced deep learning model. Accuracy: 96.13% (validated through 5-fold cross-validation)": "Įkelkite krūtinės rentgeno nuotrauką pneumonijai aptikti naudojant mūsų pažangų giliojo mokymosi modelį. Tikslumas: 96,13% (patvirtinta 5 kartų kryžminiu patikrinimu)",
    ...
    "Abnormal Probability:": "Pneumonijos tikimybė:",
    "ago": "prieš",
    "MB": "MB",
    "s": "s",
    ...
    "Classes:": "Klasės:",
    "Normal, Abnormal": "Normalus, Pneumonija",
